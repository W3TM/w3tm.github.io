...
Next on the agenda is to try interfacing the DigiRig with the IC-705 via wifi.
Since the configuration options aren't especially accessible, this may necessitate flashing a new micro SD card.
But it would save a cable.
