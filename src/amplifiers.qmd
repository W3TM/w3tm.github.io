...
```{mermaid}
%%| title: "SPE Expert Linear 1K-FA"
%%| fig-cap: "SPE Expert Linear 1K-FA Block Diagram"
flowchart TD
  A[SPE Expert Linear 1K-FA] --- B(IC-7300)
  A --- C(Flex 6400)
  A --- D(220 V outlet)
```

Here is the [PDF manual](pdf/EXPERT1K-FA-EN-rev.3.2.pdf).
